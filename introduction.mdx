...
<iframe style="height: 8rem; box-sizing: border-box; position: relative; border: 0px; width: 100%;" alt="Hero Light" classname="block dark:hidden" src="/logo/light.svg" ></iframe>

<iframe style="height: 8rem; box-sizing: border-box; position: relative; border: 0px; width: 100%;" alt="Hero Dark" classname="hidden dark:block" src="/logo/dark.svg" ></iframe>
